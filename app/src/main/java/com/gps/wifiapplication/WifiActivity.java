...
public class WifiActivity extends Activity implements SwipeRefreshLayout.OnRefreshListener, View.OnClickListener, WifiBrocastReceiver.WifiStateChangeListener {
    ...
    private void initDialog() {
        ...
        tvSsid = re.findViewById(R.id.tv_ssid);
        etPwd = re.findViewById(R.id.et_pwd);
        btnConn = re.findViewById(R.id.btn_conn);
